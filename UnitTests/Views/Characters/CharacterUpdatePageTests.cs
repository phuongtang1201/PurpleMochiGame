...
namespace UnitTests.Views
{
    ...
    public class CharacterUpdatePageTests : CharacterUpdatePage
    {
        ...
        [Test]
        public void CharacterUpdatePage_Attack_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterUpdatePage_Defense_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterUpdatePage_Speed_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterUpdatePage_Image_OnPickerValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
