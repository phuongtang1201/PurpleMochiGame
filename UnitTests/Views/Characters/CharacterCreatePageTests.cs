...
namespace UnitTests.Views
{
    ...
    public class CharacterCreatePageTests : CharacterCreatePage
    {
        ...
        public void CharacterCreatePage_Save_Clicked_Null_Picker_Should_Pass()
        {
            // Arrange
            page.ViewModel.Data.ImageURI = null;
            page.Image_OnPickerValueChanged(null, null);
        ...
        [Test]
        public void CharacterCreatePage_Defense_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterCreatePage_Attack_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterCreatePage_Speed_OnSliderValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
        ...
        [Test]
        public void CharacterCreatePage_Entry_CheckNotEmpty_Null_Description_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void CharacterCreatePage_Image_OnPickerValueChanged_Default_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel();
            var ViewModel = new GenericViewModel<CharacterModel>(data);
