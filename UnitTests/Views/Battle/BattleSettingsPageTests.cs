...
namespace UnitTests.Views
{
    ...
    public class BattleSettingsPageTests
    {
        ...
        [Test]
        public void BattleSettingsPage_AllowBossMonsters_Toggled_Default_Should_Pass()
        {
            // Arrange

            var control = (Switch)page.FindByName("AllowBossMonstersSwitch");
            var current = control.IsToggled;

            ToggledEventArgs args = new ToggledEventArgs(current);

            // Act
            page.AllowBossMonsters_Toggled(null, args);
        ...
        [Test]
        public void BattleSettingsPage_AllowBossMonsters_Toggled_True_Default_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void BattleSettingsPage_AllowZombieMonsters_Toggled_True_Default_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void BattleSettingsPage_AllowSlowestFirst_Toggled_Default_Should_Pass()
        {
            // Arrange

            var control = (Switch)page.FindByName("AllowSlowestFirstSwitch");
            var current = control.IsToggled;

            ToggledEventArgs args = new ToggledEventArgs(current);

            // Act
            page.SlowestFirst_Toggled(null, args);
        ...
        [Test]
        public void BattleSettingsPage_AllowSlowestFirst_Toggled_True_Default_Should_Pass()
        {
            // Arrange
