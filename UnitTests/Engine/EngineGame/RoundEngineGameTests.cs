...
namespace UnitTests.Engine.EngineGame
{
    ...
    public class RoundEngineGameTests
    {
        ...
        [Test]
        public async Task RoundEngine_GetItemFromPoolIfBetter_Valid_Head_Better_Should_Pass()
        {
            Engine.EngineSettings.MonsterList.Clear();
        ...
        [Test]
        public async Task RoundEngine_GetItemFromPoolIfBetter_InValid_Head_Worse_Should_Skip()
        {
            Engine.EngineSettings.MonsterList.Clear();
