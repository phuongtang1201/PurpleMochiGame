        ...
        public static List<CharacterModel> LoadData(CharacterModel temp)
        {
            ...
            var datalist = new List<CharacterModel>()
            {
                ...
                new CharacterModel {
                    ...
                    Defense = 3,
                    Speed = 7,
                    ImageURI = "chefyellow100px2x.png",
                    Head = HeadString,
                    Necklass = NecklassString,
                    PrimaryHand = PrimaryHandString,
                    OffHand = OffHandString,
                ...
                new CharacterModel {
                    ...
                    Defense = 5,
                    Speed = 1,
                    ImageURI = "chefpurple100px2x.png",
                    Head = HeadString,
                    Necklass = NecklassString,
                    PrimaryHand = PrimaryHandString,
                    OffHand = OffHandString,
                ...
                new CharacterModel {
                    ...
                    Defense = 8,
                    Speed = 3,
                    ImageURI = "cheforange100px2x.png",
                    Head = HeadString,
                    Necklass = NecklassString,
                    PrimaryHand = PrimaryHandString,
                    OffHand = OffHandString,
